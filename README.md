...
3. The coupling between the singular vectors, **normalized** by the $p$-norm of $S_1$,
$$m_K(J_1, J_2) = \frac{|| U_{2,K}^TU_1 S_1 V_1^T V_{2,K} - S_{1,K} ||_F}{\lVert s_{1, K}\rVert_p}$$
